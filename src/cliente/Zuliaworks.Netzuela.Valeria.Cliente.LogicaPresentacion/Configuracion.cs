namespace Zuliaworks.Netzuela.Valeria.Cliente.LogicaPresentacion
{
    ...
    using Zuliaworks.Netzuela.Valeria.Cliente.Logica;                           // TablaMapeada, MapeoDeColumnas
    using Zuliaworks.Netzuela.Valeria.Cliente.LogicaPresentacion.ViewModels;    // TablaMapeada, MapeoDeColumnas
